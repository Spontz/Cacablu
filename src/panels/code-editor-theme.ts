...
export function registerCacabluCodeTheme(): void {
  ...
  monaco.editor.defineTheme(CACABLU_CODE_THEME, {
    ...
    rules: [
      ...
      { token: 'section', foreground: 'FFB000', fontStyle: 'bold' },
      { token: 'section.cacablu-section-ini', foreground: 'FFB000', fontStyle: 'bold' },
      { token: 'key', foreground: 'FF3DF2', fontStyle: 'bold' },
      { token: 'key.cacablu-section-ini', foreground: 'FF3DF2', fontStyle: 'bold' },
      { token: 'section.ini', foreground: 'FFB000', fontStyle: 'bold' },
      { token: 'key.ini', foreground: 'FF3DF2', fontStyle: 'bold' },
      { token: 'string.cacablu-section-ini', foreground: 'E8FF00' },
      { token: 'number.cacablu-section-ini', foreground: 'FF7A00' },
      { token: 'constant.cacablu-section-ini', foreground: 'FF5A1F', fontStyle: 'bold' },
      { token: 'comment.cacablu-section-ini', foreground: 'C879FF', fontStyle: 'italic' },
      { token: 'delimiter.cacablu-section-ini', foreground: 'FFFA6B' },
      { token: 'string.ini', foreground: 'E8FF00' },
      { token: 'number.ini', foreground: 'FF7A00' },
      { token: 'comment.ini', foreground: 'C879FF', fontStyle: 'italic' },
      { token: 'delimiter.ini', foreground: 'FFFA6B' },
    ],
    colors: {
