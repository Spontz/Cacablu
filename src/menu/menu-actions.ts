...
export function createDefaultMenuActions(): MenuActionDefinition[] {
  return [
    ...
    { id: 'reset-layout', label: 'Close all panels', menu: 'View' },
    { id: 'toggle-display-timeline-ids', label: 'Display IDs', menu: 'View' },
    ...
    { id: 'toggle-section-editor', label: 'Section Editor', menu: 'Window' },
