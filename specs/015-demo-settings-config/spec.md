...
- **FR-006**: The panel MUST contain a `Debug grid` checkbox stored in the project DB as `grid`.
- **FR-006a**: When Cacablu sends Demo Settings to Phoenix, it MUST map the DB `grid` value to the Phoenix API field `debugFloor`.
