...
| `debugGrid` | `boolean` | Read from and written to the project DB as `grid`. Sent to Phoenix as `debugFloor`. |
...
| `debugFloor` | `boolean` | Phoenix API field populated from the DB `grid` value. |
